# 
class sweat_band extends bamboosnowtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  bloviation: =>
    T.div "#bloviation.contents", id: "bloviation", class: "contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.div ".clearfix.mb2.border-bottom.fit.right.fancybox", class: "clearfix mb2 border-bottom fit right fancybox", =>
          T.comment "href=@pathToMe/sweat-band.jpeg  &amp;quot;no sweat head band@240px 320px&amp;quot; title=null text=sweatband.right.fancybox"
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-soft-goods/sweat-band/sweat-band.jpeg  &amp;quot;no sweat head bandnogo!", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-soft-goods/sweat-band/sweat-band-t.jpeg  &amp;quot;no sweat head bandnogo!", alt: "sweatband"
