...
renderer = class  other_voices_and_insights extends celarientemplate
  ...
  storybar: =>
    T.div "#storybar.o-grid__cell.order-2.bg-lighten-2", =>
      T.h1 => T.raw "Other Voices and Insights"
      T.hr()
      @bloviation()
  # 
  # section bloviation
  ...
  bloviation: =>
    T.div "#bloviation.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "You may want some new insights into hypnosis, therapy, mind and emotion management."
      T.p => T.raw "I’m starting these pages for your enjoyment."
  # 
  # section header
  # 
...
db[id="597b839bd3cfff7cc5f92703"] =
  ...
  tags: []
  memberOf: []
  created: "2017-07-28T18:34:03.309Z"
  lastEdited: "2017-07-28T18:34:03.309Z"
  published: "2017-07-28T18:34:03.309Z"
