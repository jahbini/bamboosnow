...
"""
  ...
  # 
  a_new_natural_resource_to_lift_our_boats: =>
    T.h3 "#a-new-natural-resource-to-lift-our-boats", id: "a-new-natural-resource-to-lift-our-boats", => T.raw "A new natural resource to lift our boats"
  # 
  # section nature_is_the_source_of_all_abundance
  # 
  nature_is_the_source_of_all_abundance: =>
    T.h3 "#nature-is-the-source-of-all-abundance", id: "nature-is-the-source-of-all-abundance", => T.raw "Nature is the source of all abundance"
  # 
  # section a_rising_tide_lifts_all_boats
  # 
  a_rising_tide_lifts_all_boats: =>
    T.h3 "#a-rising-tide-lifts-all-boats", id: "a-rising-tide-lifts-all-boats", => T.raw "A Rising Tide Lifts All boats"
  # 
  # section sidecar
  # 
  sidecar: =>
