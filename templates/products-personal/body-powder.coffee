...
"""
      T.p =>
        T.div ".clearfix.mb2.border-bottom.fit.soudelar.classes.fancybox", class: "clearfix mb2 border-bottom fit soudelar classes fancybox", =>
          ...
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-personal/body-powder/soudelar.jpg &amp;quot;No Power, No Water -- Lots of Sweat&amp;quot;", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-personal/body-powder/soudelar-t.jpg &amp;quot;No Power, No Water -- Lots of Sweat&amp;quot;", alt: "Soudelar Damage"
