...
"""
  ...
  bloviation: =>
    T.div "#bloviation.contents", id: "bloviation", class: "contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.div ".clearfix.mb2.border-bottom.fit.shower.right.fancybox.ml1", class: "clearfix mb2 border-bottom fit shower right fancybox ml1", =>
          T.comment "href=@pathToMe/shower.jpg &amp;quot;Scrub-a-dub clean&amp;quot; title=null text=#shower.right.fancybox.ml1"
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-personal/shower-scrub/shower.jpg &amp;quot;Scrub-a-dub clean&amp;quot;", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-personal/shower-scrub/shower-t.jpg &amp;quot;Scrub-a-dub clean&amp;quot;", alt: "alt"
