...
"""
  ...
  # 
  bamboo_snow_the_multi_purpose_boon_for_the_world: =>
    T.h4 "#bamboo-snow-the-multi-purpose-boon-for-the-world", id: "bamboo-snow-the-multi-purpose-boon-for-the-world", => T.raw "Bamboo Snow: the Multi-Purpose Boon for the World"
  # 
  # section sidecar
  # 
  sidecar: =>
