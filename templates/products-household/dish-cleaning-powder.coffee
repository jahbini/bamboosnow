...
"""
  ...
  bloviation: =>
    T.div "#bloviation.contents", id: "bloviation", class: "contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.div ".clearfix.mb2.border-bottom.fit.dirty.fancybox.fig-20", class: "clearfix mb2 border-bottom fit dirty fancybox fig-20", =>
          T.comment "href=@pathToMe/dirty.jpg &amp;quot;Dirty Lid&amp;quot; title=null text=Dirty@dirty.fancybox.fig-20"
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-household/dish-cleaning-powder/dirty.jpg &amp;quot;Dirty Lid&amp;quot;", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-household/dish-cleaning-powder/dirty-t.jpg &amp;quot;Dirty Lid&amp;quot;", alt: "Dirty"
          T.p ".caption", class: "caption"
        T.div ".clearfix.mb2.border-bottom.fit.ready.fancybox.fig-20", class: "clearfix mb2 border-bottom fit ready fancybox fig-20", =>
          T.comment "href=@pathToMe/ready.jpg &amp;quot;Ready, get set&amp;quot; title=null text=Ready@ready.fancybox.fig-20"
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-household/dish-cleaning-powder/ready.jpg &amp;quot;Ready, get set&amp;quot;", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-household/dish-cleaning-powder/ready-t.jpg &amp;quot;Ready, get set&amp;quot;", alt: "Ready"
          T.p ".caption", class: "caption"
        T.div ".clearfix.mb2.border-bottom.fit.fancybox.fig-20", class: "clearfix mb2 border-bottom fit fancybox fig-20", =>
          T.comment "href=@pathToMe/just-brush.jpg &amp;quot;Go!&amp;quot; title=null text=justBrush@fancybox.fig-20"
          T.a ".block.mx-auto", class: "block mx-auto", href: "products-household/dish-cleaning-powder/just-brush.jpg &amp;quot;Go!&amp;quot;", title: "title", =>
            T.img ".fig-img", class: "fig-img", src: "products-household/dish-cleaning-powder/just-brush-t.jpg &amp;quot;Go!&amp;quot;", alt: "justBrush"
          T.p ".caption", class: "caption"
        @cleanTop()
        @cleanBottom()
      T.ol =>
  ...
  # 
  cleanBottom: =>
    T.div "#cleanBottom.clearfix.mb2.border-bottom.fit.#cleanBottom.fig-20.clear.fancybox", id: "cleanBottom", class: "clearfix mb2 border-bottom fit #cleanBottom fig-20 clear fancybox", =>
      ...
      T.a ".block.mx-auto", class: "block mx-auto", href: "products-household/dish-cleaning-powder/clean-bottom.jpg &amp;quot;and bottom&amp;quot;", title: "title", =>
        T.img ".fig-img", class: "fig-img", src: "products-household/dish-cleaning-powder/clean-bottom-t.jpg &amp;quot;and bottom&amp;quot;", alt: "Squeaky Clean Underneath"
      T.p ".caption", class: "caption"
  # 
  # section cleanTop
  # 
  cleanTop: =>
    T.div "#cleanTop.clearfix.mb2.border-bottom.fit.#cleanTop.fancybox.fig-20", id: "cleanTop", class: "clearfix mb2 border-bottom fit #cleanTop fancybox fig-20", =>
      T.comment "href=@pathToMe/clean-top.jpg &amp;quot;Clean top&amp;quot; title=null text=Squeaky Clean Top@#cleanTop.fancybox.fig-20"
      T.a ".block.mx-auto", class: "block mx-auto", href: "products-household/dish-cleaning-powder/clean-top.jpg &amp;quot;Clean top&amp;quot;", title: "title", =>
        T.img ".fig-img", class: "fig-img", src: "products-household/dish-cleaning-powder/clean-top-t.jpg &amp;quot;Clean top&amp;quot;", alt: "Squeaky Clean Top"
      T.p ".caption", class: "caption"
  # 
  # section sidecar
  # 
