# 
class marketing_bamboo_snow extends bamboosnowtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  storybar: =>
    T.div "#storybar.o-grid__cell.order-1.bg-lighten-4", id: "storybar", class: "o-grid__cell order-1 bg-lighten-4", =>
      T.h1 => T.raw "Marketing Bamboo Snow"
      T.hr()
      @bloviation()
  # 
  # section bloviation
  ...
  bloviation: =>
    T.div "#bloviation.contents", id: "bloviation", class: "contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      @three_marketing_regions_local_us_mainland_worldwide()
      T.p => T.raw "The Saipan market is very small and shallow.  Most suitable for local use are craft and cleaning powders."
      T.p => T.raw "The US Mainland market has many possibilities:"
  # 
  # section three_marketing_regions_local_us_mainland_worldwide
  # 
  three_marketing_regions_local_us_mainland_worldwide: =>
    T.h3 "#three-marketing-regions-local-us-mainland-worldwide", id: "three-marketing-regions-local-us-mainland-worldwide", => T.raw "Three Marketing Regions - Local, US Mainland, Worldwide"
  # 
  # section sidecar
  # 
  sidecar: =>
...
page = new marketing_bamboo_snow
