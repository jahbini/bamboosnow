...
"""
  ...
  # 
  experimental_and_potential: =>
    T.h3 "#experimental-and-potential", id: "experimental-and-potential", => T.raw "experimental and potential"
  # 
  # section sewn_goods
  # 
  sewn_goods: =>
    T.h3 "#sewn-goods", id: "sewn-goods", => T.raw "Sewn goods"
  # 
  # section mixed_with_paraffin
  # 
  mixed_with_paraffin: =>
    T.h3 "#mixed-with-paraffin", id: "mixed-with-paraffin", => T.raw "Mixed with Paraffin"
  # 
  # section mixed_with_liquid
  # 
  mixed_with_liquid: =>
    T.h3 "#mixed-with-liquid", id: "mixed-with-liquid", => T.raw "Mixed with Liquid"
  # 
  # section placed_or_sewn_in_a_cloth_bag
  # 
  placed_or_sewn_in_a_cloth_bag: =>
    T.h3 "#placed-or-sewn-in-a-cloth-bag", id: "placed-or-sewn-in-a-cloth-bag", => T.raw "Placed or Sewn in a Cloth Bag"
  # 
  # section sifted
  # 
  sifted: =>
    T.h3 "#sifted", id: "sifted", => T.raw "Sifted"
  # 
  # section unprocessed
  # 
  unprocessed: =>
    T.h3 "#unprocessed", id: "unprocessed", => T.raw "Unprocessed"
  # 
  # section products_listed_in_increasing_processing_and_manufacturing_cost
  # 
  products_listed_in_increasing_processing_and_manufacturing_cost: =>
    T.h2 "#products-listed-in-increasing-processing-and-manufacturing-cost", id: "products-listed-in-increasing-processing-and-manufacturing-cost", => T.raw "Products listed in increasing processing and manufacturing cost"
  # 
  # section product_prototypes_for_your_inspiration_
  # 
  product_prototypes_for_your_inspiration_: =>
    T.h1 "#product-prototypes-for-your-inspiration-", id: "product-prototypes-for-your-inspiration-", => T.raw "Product prototypes for your inspiration."
  # 
  # section sidecar
  # 
  sidecar: =>
