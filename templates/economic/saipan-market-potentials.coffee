# #-------- class start
renderer = class  saipan_market_potentials extends siteTemplate
  # 
  # section html
  # 
  # 
...
"""
  ...
  # 
  marketplace_analysis: =>
    T.h2 "#marketplace-analysis", => T.raw "Marketplace analysis"
  # 
  # section local_buying_segments_and_market_structure
  # 
  local_buying_segments_and_market_structure: =>
    T.h3 "#local-buying-segments-and-market-structure", => T.raw "Local Buying Segments and Market Structure"
  # 
  # section analysis_of_saipan_market_potential_for_products_from_bamboo_snow
  # 
  analysis_of_saipan_market_potential_for_products_from_bamboo_snow: =>
    T.h2 "#analysis-of-saipan-market-potential-for-products-from-bamboo-snow", => T.raw "Analysis of Saipan Market Potential for Products from Bamboo Snow"
  # 
  # section sidecar
  # 
  # 
