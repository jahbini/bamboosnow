...
exports.Html = (cb)->
    console.log "in HTML"
    siteTemplate = fs.readFileSync "./templates/bamboosnowtemplate.coffee"
    HalvallaCard = fs.readFileSync "./templates/card.coffee"
    console.log "Generating site"
    a=pfs(
      gulp.src("./templates/**/*.coffee")
        .pipe gulpWatch  "./templates/**/*.coffee"
...
exports['AppJs'] = (cb)->
    ...
    bb= browserify "./app/initialize.coffee",
      ...
      extensions: ['.coffee']
      fullPaths: true
      paths:['./node_modules','./app',"./site","./payload-","./node_modules"]
...
exports['Assets'] = (cb)->
    ...
    sources=["./payload-/assets/**/*", "./templates/**/*.jpg", "./templates/**/*.png" ]
    a=pfs(
      gulp.src sources
...
exports['Css'] = do (site) -> return (cb)->
    ...
    b=()->
      ...
      return pfs(gulp.src([ "./app/css/*.css" , "./payload-/*.css" ])
...
exports.watch = (cb)->
  gulp.watch './templates/**/*.css',exports.Css
  gulp.watch ["./payload-/assets/**/*", "./templates/**/*.jpg", "./templates/**/*.png" ] , exports.Assets
  gulp.watch  "./templates/**/*.coffee",exports.Html().then (done)->
    browserSync.reload()
